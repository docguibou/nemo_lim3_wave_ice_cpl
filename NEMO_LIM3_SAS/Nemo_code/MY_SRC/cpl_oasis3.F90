MODULE cpl_oasis3
   ...
   INTEGER, PUBLIC, PARAMETER ::   nmaxcat=6    ! Maximum number of coupling fields
   INTEGER, PUBLIC, PARAMETER ::   nmaxcpl=6    ! Maximum number of coupling fields
   ...
   !! $Id: cpl_oasis3.F90 7646 2017-02-06 09:25:03Z timgraham $
