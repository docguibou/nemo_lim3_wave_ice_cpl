...
CONTAINS
   ...
   SUBROUTINE lim_thd_dh( kideb, kiut )
      ...
      END DO
      !WRITE(*,*) 'zq_su init :', zq_su(30)
      !WRITE(*,*) 'zq_bo init:', zq_bo(30) 
      !
      !------------------------------------------------------------------------------!
      ...
      !--------------------------
!WRITE(*,*) "Surf. Ice. Ablation  :", "delta = ",zdeltah(30,:),"ht =", zh_i(30,:)
      ...
      DO jk = 1, nlay_i
         DO ji = kideb, kiut
            ...
            IF( t_i_1d(ji,jk) >= ztmelts ) THEN !!! Internal melting
             !  WRITE(*,*) "Internal melting", "temp ice :" ,t_i_1d(ji,jk), "temp melt :",ztmelts,"salinity : ", s_i_1d(ji,jk)
      ...
      END DO
      !WRITE(*,*) "ENN OF Surf. Ice. Ablation  :", "delta = ",zdeltah(30,:),"ht =", zh_i(30,:)
      ...
      !WRITE(*,*) "BEGIN OF Basal Ice. Ablation  :", "delta = ",zdeltah(30,:),"ht =", zh_i(30,:)
      num_iter_max = 1
      ...
      DO iter = 1, num_iter_max
         ...
         END DO
      END DO
      !WRITE(*,*) 'between', zt_i_new - rt0,zt_i_new , rt0, zEi,cpic ,t_bo_1d(30),zt_i_new - ztmelts,cpic,lfus
      ...
      DO jk = nlay_i, 1, -1
       ...
       !        WRITE(*,*) 'IF'
        ...
        !       WRITE(*,*) 'IF IF'
                  ...
                  zdeltah   (ji,jk) = MIN( 0._wp , - zh_i(ji,jk) )  ! internal melting occurs when the internal temperature is above freezing     
                                                                    ! this should normally not happen, but sometimes, heat diffusion leads to this
                !  IF (ji==50) WRITE(*,*) ht_i_1d(30),dh_i_bott(30) ,'inside update temp'
         ...
         END DO
      END DO
      !WRITE(*,*) "ENN OF Basal Ice. Ablation  :", "delta = ",zdeltah(30,:),"ht =", zh_i(30,:)
      !-------------------------------------------
